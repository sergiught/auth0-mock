...
func TestLoadFromEnv_Defaults(t *testing.T) {
	...
	assert.Equal(t, "0.0.0.0:8443", cfg.HTTPSAddress)
...
func clearEnv(t *testing.T) {
	...
	for _, k := range []string{
		...
		"TLS_HOSTNAMES", "SIGNING_KEY_FILE", "ISSUER_URL", "DEFAULT_AUDIENCE",
		"ACCESS_TOKEN_TTL", "ID_TOKEN_TTL", "LOG_LEVEL", "SPEC_VALIDATION_STRICT",
		"READ_HEADER_TIMEOUT", "SHUTDOWN_TIMEOUT",
	} {
		_ = os.Unsetenv(k)
	}
}
